...
def main():
    ...
    cap = cv2.VideoCapture('/home/vdo-ubuntu/Videos/DVR_ch12_main_20180716130000_20180716140000_1.avi')
    ...
    with open(out_file, 'w') as f_out:
        ...
        for frame in range(0, frames):  #frame numbers begin at 0!
            ...
            for d in trackers:
                ...
                cv2.rectangle(img, (int(d[0]), int(d[1])), (int(d[2]), int(d[3])), (0, 255, 0), 2)
                cv2.putText(img, 'id = %d' % (d[4]), (int(d[0]), int(d[3])), cv2.FONT_HERSHEY_DUPLEX, 1, (0, 0, 255))
            out.write(img)
