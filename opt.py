...
"----------------------------- Save options ------------------------------"
parser.add_argument('--save_ori', help='save original image', default=False)
parser.add_argument('--save_pose', help='save pose image', default=False)
parser.add_argument('--draw_bbox', help='draw bounding box', default=False)
